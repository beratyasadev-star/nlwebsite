    ...
    <footer className="bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white mt-24 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">Diaspora & Azadî</h3>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col items-center space-y-6">
            <div className="text-center">
              <h4 className="font-bold mb-4 text-lg text-white">Sosyal Medya</h4>
              <div className="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                ...
                <a
                  ...
                  className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white hover:bg-green-600 transition-all duration-200 hover:scale-110 hover:shadow-lg hover:-translate-y-1"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-sky-500 rounded-full flex items-center justify-center text-white hover:bg-sky-600 transition-all duration-200 hover:scale-110 hover:shadow-lg hover:-translate-y-1"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-all duration-200 hover:scale-110 hover:shadow-lg hover:-translate-y-1"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-sky-400 rounded-full flex items-center justify-center text-white hover:bg-sky-500 transition-all duration-200 hover:scale-110 hover:shadow-lg hover:-translate-y-1"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-500 rounded-full flex items-center justify-center text-white hover:from-purple-700 hover:to-pink-600 transition-all duration-200 hover:scale-110 hover:shadow-lg hover:-translate-y-1"
            ...
            <div className="text-center text-gray-400">
              <p>&copy; {currentYear} Diaspora & Azadî. {dict.footer.copyright}</p>
            </div>
          </div>
        </div>
      </div>
