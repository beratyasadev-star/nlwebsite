...
export default function Header({ locale, dict }: HeaderProps) {
  ...
  return (
    <header className="bg-white sticky top-0 z-50 shadow-lg">
      ...
      {/* Mobile-Only Sosyal Medya Çubuğu - Her Sayfada Görünür */}
      <div className="md:hidden bg-slate-50 border-b border-slate-200 py-2.5">
        <div className="flex items-center justify-center gap-4">
          {socialMediaLinks.facebook.enabled && (
            <a
              ...
              className="w-9 h-9 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-all active:scale-95 shadow-sm"
          ...
          {socialMediaLinks.instagram.enabled && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 bg-gradient-to-br from-purple-600 to-pink-500 rounded-full flex items-center justify-center text-white hover:from-purple-700 hover:to-pink-600 transition-all active:scale-95 shadow-sm"
          ...
          {socialMediaLinks.whatsapp.enabled && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 bg-green-500 rounded-full flex items-center justify-center text-white hover:bg-green-600 transition-all active:scale-95 shadow-sm"
          ...
          {socialMediaLinks.telegram.enabled && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 bg-sky-500 rounded-full flex items-center justify-center text-white hover:bg-sky-600 transition-all active:scale-95 shadow-sm"
          ...
          {socialMediaLinks.twitter.enabled && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 bg-sky-400 rounded-full flex items-center justify-center text-white hover:bg-sky-500 transition-all active:scale-95 shadow-sm"
