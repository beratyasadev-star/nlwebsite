/**
 * İçerikleri sadece Hollandaca ve İngilizce'ye çevirir
 * Kullanım: npx tsx scripts/translate-nl-en.ts
 */
...
async function saveTranslation(
  ...
  try {
    ...
    if (collection === 'sss') {
      ...
      // Haber, Blog, Duyuru, Rehber için sadece title ve excerpt
...
async function main() {
  console.log('🌍 Hollandaca ve İngilizce çeviri işlemi başlıyor...\n')

  const targetLocales: TargetLanguage[] = ['nl', 'en']
